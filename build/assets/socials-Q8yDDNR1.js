import{c as O,n as W,D as l,a as _,i as I,s as S,O as h,K as T,R as f,o as F,x as c,L as D,k as C,P as N,A as j,Q as A,y as $,j as d,C as P,V as M,E as u,X as U,S as v,Y as q,M as R,T as x}from"./index-CZ8dBzBt.js";const z=O`
  :host {
...
`;var k=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let L=class extends I{constructor(){super(),this.unsubscribe=[],this.checked=A.state.isLegalCheckboxChecked,this.unsubscribe.push(A.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var E;const{termsConditionsUrl:e,privacyPolicyUrl:o}=h.state,r=(E=h.state.features)==null?void 0:E.legalCheckbox,s=!!(e||o)&&!!r&&!this.checked,a=s?-1:void 0;return c`
    ...
    `}};L.styles=V;k([l()],L.prototype,"checked",void 0);L=k([_("w3m-connect-socials-view")],L);const B=O`
  wui-logo {
    width: 80px;
    height: 80px;
