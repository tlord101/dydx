import{M as x,ab as ae,R as c,C as de,c as C,r as j,a as w,i as y,x as d,n as l,y as W,A as _,D as u,e as ue,v as D,j as g,z as L,a7 as he,V,E as U,O as R,s as F,f as pe,S as O,K as z,a4 as ee,T as me,U as ne,ac as fe,ad as we}from"./index-CeeBl9zW.js";import"./index-WloD5EoU.js";import{S as be}from"./SwapController-DmrGy48L.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
